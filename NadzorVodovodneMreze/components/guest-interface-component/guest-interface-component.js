	...
	render() {
		...
		<View style = { styles.container }>
			<View style = { styles.meni }>
				...
				<Image style={styles.menuImageStyle}  source={require('C:/Projects/MislimVod/NadzorVodovodneMreze/resursi/slike/game.png')} />
				</TouchableOpacity>
				<TouchableOpacity onPress = { () => this.onPress('Help') }>
				<Image style={styles.menuImageStyle}  source={require('C:/Projects/MislimVod/NadzorVodovodneMreze/resursi/slike/help.png')} />
				</TouchableOpacity>
			</View>
